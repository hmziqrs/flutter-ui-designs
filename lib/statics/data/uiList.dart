...
List<UIItem> uilist = [
  ...
  // new UIItem(
  //   id: 6,
  //   name: "Circle Of Dining App",
  //   designer: "queble",
  //   description:
  //       "Hello, today, I brought circle of dining app overall interface design. This is an app that combines food sharing with e-commerce. Users can share a dish through the food sharer, know the materials needed for this dish and one-click purchase, saving the user's time cost. Users can also see good dishes and commodity added to the collection function.",
  //   source: "dribbble",
  //   miniApp: "codaHome",
  //   testKey: UIListDataTestKeys.etc,
  //   link: "https://dribbble.com/shots/7035041-Circle-Of-Dining-App",
  //   thumbnail: "assets/thumbnails/circle_of_dinning_app.jpg",
  //   tabletSupport: true,
  //   landscapeSupport: true,
  //   webSupport: true,
  //   desktopSupport: true,
  ...
  new UIItem(
    ...
    source: "dribbble",
    miniApp: "ccnHome",
    testKey: UIListDataTestKeys.ccn,
    link: "https://dribbble.com/shots/7333348-ChefCraft",
    thumbnail: "assets/thumbnails/chef_craft_nickelfox.jpg",
    tabletSupport: true,
    landscapeSupport: true,
    webSupport: true,
    desktopSupport: true,
